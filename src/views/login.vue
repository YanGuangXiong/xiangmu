        ...
        <div id="section2" class="section-w3ls">
          ...
          <el-form action="#" method="post">
              ...
              <div class="input">
                ...
                <input type="text" placeholder="请输入手机号码" name="name" required />
              </div>
              <div class="input">
                <span class="fa fa-key" aria-hidden="true"></span>

                <input type="password" placeholder="请设置6-20位数字和字母组合密码" name="password" required />
              </div>  
              <div class="input">
              ...
              <div class="input" style="width:135px;height:20px">
                ...
                <input placeholder="请输入图形验证码" name="yanzhengma" required />
          ...
          <article>
           <el-form action="#" method="post">
            ...
            <input  type="password" placeholder="请设置6-20位数字和字母组合密码"  name="password" required />  
              ...
              <div class="input">
                <span class="fa fa-envelope-o" aria-hidden="t,i9ue"></span>
                <input type="password" placeholder="请输入邮箱" name="password" required />
              </div>
              <div class="input" style="width:135px;height:20px">
                <span class="fa fa-book mark" aria-hidden="true"></span>
                <input placeholder="请输入图形验证码" name="dfddf" required />
               <div @click="refreshCode">
                  <s-identify :identifyCode="identifyCode1" id="a1"></s-identify>
                </div>
              </div>
              <button type="submit" class="btn submit last-btn">注册</button>
            </el-form>
          </article>
        </div>
      </div>
